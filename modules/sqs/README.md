...
| <a name="input_allowed_queue_actions"></a> [allowed\_queue\_actions](#input\_allowed\_queue\_actions) | Allowed SQS actions for the queue policy | `list(string)` | <pre>[<br/>  "sqs:SendMessage",<br/>  "sqs:ReceiveMessage",<br/>  "sqs:DeleteMessage",<br/>  "sqs:GetQueueAttributes",<br/>  "sqs:GetQueueUrl"<br/>]</pre> | no |
